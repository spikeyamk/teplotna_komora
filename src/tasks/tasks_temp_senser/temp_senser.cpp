...
namespace tasks {
    ...
    void TempSenser::init() {
        if(transceiver_front.init() != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::TransceiverInit::FRONT>();
        } else if(transceiver_rear.init() != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::TransceiverInit::REAR>();
        }
        ...
        if(extension_front.configure(sens::max31865::Configuration()) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearConfigure::FRONT>();
        } else if(extension_rear.configure(sens::max31865::Configuration()) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearConfigure::REAR>();
        }

        if(extension_front.read_configuration() != sens::max31865::Configuration()) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearConfigureValidation::FRONT>();
        } else if(extension_rear.read_configuration() != sens::max31865::Configuration()) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearConfigureValidation::REAR>();
        }

        if(extension_front.set_filter_select(sens::max31865::Masks::FilterSelect::Or::FIFTY_HZ) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::SetFilterSelect::FRONT>();
        } else if(extension_rear.set_filter_select(sens::max31865::Masks::FilterSelect::Or::FIFTY_HZ) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::SetFilterSelect::REAR>();
        }

        if(extension_front.read_filter_select() != sens::max31865::Masks::FilterSelect::Or::FIFTY_HZ) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::FilterSelectValidation::FRONT>();
        } else if(extension_rear.read_filter_select() != sens::max31865::Masks::FilterSelect::Or::FIFTY_HZ) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::FilterSelectValidation::REAR>();
        }

        if(extension_front.set_fault_threshold(fault_threshold) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::SetFaultThreshold::FRONT>();
        } else if(extension_rear.set_fault_threshold(fault_threshold) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::SetFaultThreshold::REAR>();
        }

        if(extension_front.read_fault_threshold() != fault_threshold) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::FaultThresholdValidation::FRONT>();
        } else if(extension_rear.read_fault_threshold() != fault_threshold) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::FaultThresholdValidation::REAR>();
        }

        if(extension_front.configure(configuration) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::Configure::FRONT>();
        } else if(extension_rear.configure(configuration) != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::Configure::REAR>();
        }

        if(extension_front.read_configuration() != configuration) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ConfigureValidation::FRONT>();
        } else if(extension_rear.read_configuration() != configuration) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ConfigureValidation::REAR>();
        }

        if(extension_front.clear_fault_status() != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearFaultStatus::FRONT>();
        } else if(extension_rear.clear_fault_status() != HAL_OK) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearFaultStatus::REAR>();
        }
        ...
        if(extension_front.read_fault_status() != fault_status_nofault) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearFaultStatusValidation::FRONT>();
        } else if(extension_rear.read_fault_status() != fault_status_nofault) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::ClearFaultStatusValidation::REAR>();
        }

        if(extension_front.run_auto_fault_detection() != fault_status_nofault) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::RunAutoFaultDetection::FRONT>();
        } else if(extension_rear.run_auto_fault_detection() != fault_status_nofault) {
            bksram::write_reset<bksram::ErrorCodes::TempSenser::Init::MAX31865::Extension::RunAutoFaultDetection::REAR>();
        }
    ...
    void TempSenser::worker(void* arg) {
        ...
        while(1) {
            ...
            if(rtd_front.value().fault == sens::max31865::Masks::RTD_LSBs::Fault::Or::FAULT) {
                bksram::write_reset<bksram::ErrorCodes::TempSenser::Worker::MAX31865::RTD::HighOrLowFaultThreshold::FRONT>();
