...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED1_COOL_Pin|LED0_HEAT_Pin|LED2_RS232_Pin|LED3_USB_Pin
                          |BRDGF_LHIGH_Pin|BRDGF_RHIGH_Pin|BRDGR_LLOW_Pin|BRDGR_RHIGH_Pin
                          |BRDGR_LHIGH_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BRDGF_LLOW_Pin|BRDGF_RLOW_Pin|ENCB_Pin|SPI2_SEVYG_NSS_Pin
                          |I2CBB1_SCL_Pin|I2CBB1_SDA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           ...
                           PCPin */
  GPIO_InitStruct.Pin = LED1_COOL_Pin|LED0_HEAT_Pin|LED2_RS232_Pin|LED3_USB_Pin
                          |BRDGF_LHIGH_Pin|BRDGF_RHIGH_Pin|BRDGR_LLOW_Pin|BRDGR_RHIGH_Pin
                          |BRDGR_LHIGH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin */
  GPIO_InitStruct.Pin = BRDGF_LLOW_Pin|BRDGF_RLOW_Pin|ENCB_Pin|SPI2_SEVYG_NSS_Pin
                          |I2CBB1_SCL_Pin|I2CBB1_SDA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = ENCA_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ENCA_EXTI_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           PDPin PDPin */
  GPIO_InitStruct.Pin = BUT1_FR_Pin|BUT2_MR_Pin|BUT3_ML_Pin|BUT4_FL_Pin
                          |SPI3_TEMP_DRDY0_Pin|SPI3_TEMP_DRDY1_Pin;
