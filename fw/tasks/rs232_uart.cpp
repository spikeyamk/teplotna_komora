...
namespace tasks {
    ...
    void RS232_UART::worker(void* arg) {
        ...
        comm::rs232_uart::Semaphore synchronizer {};
        using Channel = comm::rs232_uart::Channel<comm::rs232_uart::Semaphore>;
        //Channel channel {};

        //boost::sml::sm<comm::rs232_uart::Connection<Channel>> connection { channel };
