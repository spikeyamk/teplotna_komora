...
namespace admin {
        ...
        error_dialog_open { false }
    {
        ...
        update_serial_port_info_combo_box_text();
        ...
        connect(periodic_timer, &QTimer::timeout, this, [this]() {
            emit request_one_shot(
                Transceiver::CommandResultPair(magic::commands::ReadTempCtl(),
                magic::results::ReadTempCtl()
            ));
        });
